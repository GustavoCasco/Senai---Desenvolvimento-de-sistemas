...
namespace Senai.InLock.WebApi.DataBaseFirst.Controllers
{
    ...
    public class EstudiosController : ControllerBase
    {
        ...
        public IActionResult Put(int id, Estudios estudioAtualizado)
        {
            ...
            return Ok($"Estudio {estudioAtualizado.IdEstudio} atualizado com sucesso");
        ...
        public IActionResult Delete(int id )
        {
            ...
            if(estudioBuscado != null)
            {
                ...
                return Ok($"Estudio {id} deletado com sucesso");
            }
            return NotFound("Nenhum estudio encontrado para deletar");
        }
